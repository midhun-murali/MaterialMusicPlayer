 ...
 * {@link MusicListFragment.OnMusicListFragmentInteractionListener} interface
...
public class MusicListFragment extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnMusicListFragmentInteractionListener) {
            mListener = (OnMusicListFragmentInteractionListener) context;
        } else {
